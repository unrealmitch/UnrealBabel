...
//Salida
#define PIN_LED A0 						//Pin Out of Leds Data [D9]

#define PIN_LED_R 9						//Top Leds
#define PIN_LED_G 10
#define PIN_LED_B 11

#define PIN_LED2_R 5					//Bot Leds
#define PIN_LED2_G 3					
#define PIN_LED2_B 6					
...
void setup () {
	...
	writeColor5050(100,0,0);writeColor5050_2(100,0,0);setColor5050();delay(time_c);
	writeColor5050(0,100,0);writeColor5050_2(0,100,0);setColor5050();delay(time_c);
	writeColor5050(0,0,100);writeColor5050_2(0,0,100);setColor5050();delay(time_c);

	writeColor5050(100,100,100); writeColor5050_2(100,100,100); setColor5050();

	if(wserver.start("| Yates' Lovers |", "camarerasycervezas", 80)){
		writeColor5050(0,50,0);setColor5050();
	}else{
		writeColor5050(50,0,0);setColor5050();
	}
	...
	//Start indicator
	RGB_Move_Msg(1);
	writeColor5050(100,0,0);writeColor5050_2(255,0,0);setColor5050();
...
void loop() {
	...
	else if (wserver.available()) mode = 1;

	if(mode == 0 || true){	//Info from PC -> Serie
		char arg;
		...
		}else if( ((now - lastAckTime) > 100) || (arg_i >= SERIAL_ARGS) ){
			Serial.print('B');
			lastAckTime = now;
			arg_i = 0;
		}
