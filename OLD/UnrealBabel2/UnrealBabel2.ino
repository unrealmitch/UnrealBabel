...
void setup () {
	...
	writeColor5050(100,0,0);setColor5050();delay(time_c);
	writeColor5050(0,100,0);setColor5050();delay(time_c);
	writeColor5050(0,0,100);setColor5050();delay(time_c);

	writeColor5050_2(100,0,0);setColor5050();delay(time_c);
	writeColor5050_2(0,100,0);setColor5050();delay(time_c);
	writeColor5050_2(0,0,100);setColor5050();delay(time_c);
	...
	//Start indicator
	RGB_Move_Msg(1);
	writeColor5050(255,0,0);writeColor5050_2(255,0,0);setColor5050();
